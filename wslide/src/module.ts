...
export default defineNuxtModule({
	...
	setup(options: WSlideModuleOptions, nuxt) {
		...
		nuxt.options.alias["#wslide/features"] = resolver.resolve("./runtime/features");
		...
		logger.success(`WSlide module loaded with ${Object.entries(config).filter(([_k, v]) => typeof v === "boolean" && v).length} features enabled`);
	},
