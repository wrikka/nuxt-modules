...
export function parseFrontmatter(content: string,): { frontmatter: SlideFrontmatter; body: string; } {
...
export function getLayoutClass(layout: string | undefined,): string {
	...
	return validLayouts.includes(layout ?? "",) ? `layout-${layout}` : "layout-default";
}
