...
export const OptionValueSchema = z.object({
	id: z.string(),
	label: z.string(), // e.g., 'Red', 'Large'
	value: z.string(), // e.g., '#FF0000', 'L'
	priceModifier: z.number().optional(), // e.g., 5 for +$5.00
})
export type OptionValue = z.infer<typeof OptionValueSchema>

export const CustomizationOptionSchema = z.object({
	id: z.string(),
	name: z.string(), // e.g., 'Color', 'Size', 'Engraving'
...
export const ProductVariantSchema = z.object({
	...
	price: z.string(), // Drizzle returns decimals as strings
	stock: z.number(),
