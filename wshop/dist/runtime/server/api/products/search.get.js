...
import { productStatusEnum } from "../../db/enums.js";
import { products } from "../../db/schemas/products/index.js";
...
export default defineEventHandler(async (event) => {
  ...
  const whereConditions = and(
    search ? ilike(products.name, `%${search}%`) : void 0,
    minPrice ? gte(products.price, String(minPrice)) : void 0,
    maxPrice ? lte(products.price, String(maxPrice)) : void 0,
    status ? eq(products.status, status) : void 0
  );
  const orderBy = (() => {
    switch (sort) {
      case "name_desc":
