...
<script setup>
const { data: backups, pending, error, refresh } = await useFetch("/api/backups", { default: () => [] });
...
const createBackup = async () => {
  ...
  try {
    ...
    console.error("Failed to create backup:", error2);
  } finally {
...
const restoreBackup = async (backupPath) => {
  ...
  try {
    ...
    console.error("Failed to restore backup:", error2);
...
const deleteBackup = async (backupPath) => {
  ...
  try {
    ...
    console.error("Failed to delete backup:", error2);
