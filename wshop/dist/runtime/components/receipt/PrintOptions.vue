    ...
    <div class="space-y-3">
      ...
      <label class="flex items-center">
        <input
          ...
          @input="$emit('update:includeLogo', $event.target.checked)"
          type="checkbox"
      ...
      <label class="flex items-center">
        <input
          ...
          @input="$emit('update:includeBarcode', $event.target.checked)"
          type="checkbox"
          class="rounded border-gray-300 text-blue-600 focus:ring-blue-500 mr-2"
        />
      ...
      <label class="flex items-center">
        <input
          ...
          @input="$emit('update:includeQRCode', $event.target.checked)"
          type="checkbox"
          class="rounded border-gray-300 text-blue-600 focus:ring-blue-500 mr-2"
        />
      ...
      <label class="flex items-center">
        <input
          ...
          @input="$emit('update:includeTerms', $event.target.checked)"
          type="checkbox"
          class="rounded border-gray-300 text-blue-600 focus:ring-blue-500 mr-2"
        />
    ...
    <div class="space-y-3">
      ...
      <div>
        ...
        <select
          ...
          @input="$emit('update:paperSize', $event.target.value)"
      ...
      <div>
        ...
        <input
          ...
          @input="$emit('update:copies', parseInt($event.target.value))"
          type="number"
          min="1"
          max="10"
          class="w-full px-3 py-2 border border-gray-300 rounded-lg"
...
defineProps({
  ...
  printerSettings: { type: Object, required: true }
});
defineEmits(["update:includeLogo", "update:includeBarcode", "update:includeQRCode", "update:includeTerms", "update:paperSize", "update:fontSize", "update:copies"]);
</script>
