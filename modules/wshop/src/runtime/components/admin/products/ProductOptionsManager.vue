...
import type { ProductOption } from '~/shared/types/product';
...
const newOption = ref({
  name: '',
  displayType: 'button' as 'button' | 'dropdown' | 'swatch',
...
const formatOptionValues = (values: { label: string; value: string }[]) => {
