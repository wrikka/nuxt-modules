// d:/wshop/server/db/schemas/customers.ts
...
// Many-to-Many join table for Customers and Segments
...
export const customerSegmentRules = pgTable("customer_segment_rules", {
	...
	field: text("field").notNull(), // e.g., 'totalSpent', 'orderCount', 'createdAt'
	operator: text("operator").notNull(), // e.g., 'gt', 'lt', 'eq', 'between'
	value: text("value").notNull(), // Can be a single value or a JSON string for ranges
})
