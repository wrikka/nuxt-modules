...
const layoutClass = computed(() => {
	...
	const layouts: Record<string, string> = {
		...
		section:
			"p-16 flex flex-col justify-center items-center bg-gradient-to-br from-wslide-primary to-wslide-secondary",
...
// Watch for slide content changes and render asynchronously
watch(
	() => props.slide?.content,
	async (newContent) => {
		if (newContent) {
			renderedContent.value = await renderSlideContent(newContent);
		} else {
