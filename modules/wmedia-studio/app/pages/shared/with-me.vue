...
const { sharedItems, loading, error, fetchSharedItems } = useCollaboration();
		...
		<div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
			<div class="mb-8">
				...
				<p class="mt-2 text-gray-600 dark:text-gray-400">
					View projects and media shared with you
				</p>
			</div>
			...
			>
				...
				<p class="mt-2 text-lg">No items shared with you</p>
				<p class="text-sm">Items shared with you will appear here</p>
			</div>
