...
import type {
	...
	VideoExportPreset,
} from "~/composables/useVideoExport";
...
const { defaultPresets, isExporting, exportProgress } = useVideoExport();
										...
										<div>
											...
											<p class="text-sm text-gray-500 dark:text-gray-400">
												{{ formatFileSize(recording.blob.size) }} • {{
													...
													(recording.duration % 60).toString().padStart(
														2,
														"0",
													)
												}}
